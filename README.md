...
**CalculatorVW3** is a smart contract written in Solidity that performs basic arithmetic operations while demonstrating fundamental smart contract development concepts and includes am access control system for most advanced operations.
...
This project was developed using the **Foundry** smart contract development framework.
...
/test directory contain unit tests for every single operation declared. 
